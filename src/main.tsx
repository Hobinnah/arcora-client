...
import CohostInvitationPage from './hosting/CohostInvitationPage.tsx';
...
const router = createBrowserRouter([
  ...
  { path: "/cohost-invite", element: <CohostInvitationPage />, errorElement: <NotFoundPage /> },
  { path: "/cohost-invite/:token", element: <CohostInvitationPage />, errorElement: <NotFoundPage /> },
  ...
  { path: "/hosting", element: <ProtectedRoute allowedRoles={hostAccessRoles} hostingPermission="overview"><HostingPage /></ProtectedRoute>, errorElement: <NotFoundPage /> },
  { path: "/hosting/setup-business", element: <ProtectedRoute allowedRoles={hostAccessRoles} hostingPermission="manage"><HostingOrganizationSetupPage /></ProtectedRoute>, errorElement: <NotFoundPage /> },
  { path: "/hosting/calendar", element: <ProtectedRoute allowedRoles={hostAccessRoles} hostingPermission="calendar"><HostingCalendarPage /></ProtectedRoute>, errorElement: <NotFoundPage /> },
  { path: "/hosting/listings", element: <ProtectedRoute allowedRoles={hostAccessRoles} hostingPermission="listings"><HostingListingsPage /></ProtectedRoute>, errorElement: <NotFoundPage /> },
  { path: "/hosting/listings/new", element: <ProtectedRoute allowedRoles={hostAccessRoles} hostingPermission="manage"><HostingCreateListingPage /></ProtectedRoute>, errorElement: <NotFoundPage /> },
  { path: "/hosting/listings/:id/edit", element: <ProtectedRoute allowedRoles={hostAccessRoles} hostingPermission="manage"><HostingListingEditorPage /></ProtectedRoute>, errorElement: <NotFoundPage /> },
  { path: "/hosting/messages", element: <ProtectedRoute allowedRoles={hostAccessRoles} hostingPermission="messages"><HostingMessagesPage /></ProtectedRoute>, errorElement: <NotFoundPage /> },
  { path: "/hosting/messages/application/:conversationID", element: <ProtectedRoute allowedRoles={hostAccessRoles} hostingPermission="messages"><HostingApplicationMessagesPage /></ProtectedRoute>, errorElement: <NotFoundPage /> },
  { path: "/messages/application/:conversationID", element: <TenantApplicationMessagesPage />, errorElement: <NotFoundPage /> },
  { path: "/hosting/review", element: <ProtectedRoute allowedRoles={hostAccessRoles} hostingPermission="manage"><HostingReviewPage /></ProtectedRoute>, errorElement: <NotFoundPage /> },
  { path: "/hosting/applications", element: <ProtectedRoute allowedRoles={hostAccessRoles} hostingPermission="applications"><HostingApplicationsPage /></ProtectedRoute>, errorElement: <NotFoundPage /> },
  { path: "/hosting/applications/:id", element: <ProtectedRoute allowedRoles={hostAccessRoles} hostingPermission="applications"><HostingApplicationReviewPage /></ProtectedRoute>, errorElement: <NotFoundPage /> },
  { path: "/hosting/invitations/new", element: <ProtectedRoute allowedRoles={hostAccessRoles} hostingPermission="manage"><HostingInviteTenantPage /></ProtectedRoute>, errorElement: <NotFoundPage /> },
  { path: "/hosting/earnings", element: <ProtectedRoute allowedRoles={hostAccessRoles} hostingPermission="manage"><HostEarningsPage /></ProtectedRoute>, errorElement: <NotFoundPage /> },
  { path: "/hosting/cohosts", element: <ProtectedRoute allowedRoles={hostAccessRoles} hostingPermission="manage"><HostCohostsPage /></ProtectedRoute>, errorElement: <NotFoundPage /> },
  { path: "/hosting/verification", element: <ProtectedRoute allowedRoles={hostAccessRoles} hostingPermission="manage"><HostVerificationPage /></ProtectedRoute>, errorElement: <NotFoundPage /> },
  { path: "/hosting/deposits", element: <ProtectedRoute allowedRoles={hostAccessRoles} hostingPermission="manage"><HostDepositsPage /></ProtectedRoute>, errorElement: <NotFoundPage /> },
  { path: "/account-settings", element: <AccountSettingsPage />, errorElement: <NotFoundPage /> },
  { path: "/verify-identity", element: <ProtectedRoute allowedRoles={hostAccessRoles} hostingPermission="manage"><IdentityVerificationPage /></ProtectedRoute>, errorElement: <NotFoundPage /> },
