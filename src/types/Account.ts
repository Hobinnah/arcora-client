...
/**
 * Interface for confirm email request payload.
 * Supports both the legacy email-based flow and the current backend userId+token flow.
 */
export interface ConfirmEmailRequest {
  /** User id from the confirmation link */
  userId?: string;
  /** Email address for legacy confirmation flow */
  emailAddress?: string;
  /** Reset token */
  token: string;
}
