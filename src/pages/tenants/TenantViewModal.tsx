...
export default function TenantViewModal({ tenant, isOpen, onClose }: TenantViewModalProps) {
    ...
    >
      ...
      >
        <div className="card-header">
          <h3 className="card-title" style={{ fontSize: '1.25rem', textTransform: 'none', color: 'var(--fg)' }}>Tenant Details</h3>
            ...
            <div className="grid2">
              <div className="field">
                ...
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  {userIDMap[String(tenant.userID)] ?? tenant.userID ?? 'N/A'}
                </div>
              </div>
              ...
              <div className="field">
                ...
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  {tenant.dateOfBirth ? new Date(tenant.dateOfBirth as any).toLocaleDateString() : 'N/A'}
                </div>
              </div>
              ...
              <div className="field">
                ...
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  <input type="checkbox" checked={tenant.isActive ?? false} readOnly style={{ cursor: 'default' }} />
                </div>
              </div>
