...
interface CreditReportingConsentAuditViewModalProps {
  creditReportingConsentAudit: CreditReportingConsentAudit | null;
  isOpen: boolean;
  onClose: () => void;
}

export default function CreditReportingConsentAuditViewModal({ creditReportingConsentAudit, isOpen, onClose }: CreditReportingConsentAuditViewModalProps) {
  ...
  if (!isOpen || !creditReportingConsentAudit) return null;
    ...
    >
      ...
      >
        <div className="card-header">
          <h3 className="card-title" style={{ fontSize: '1.25rem', textTransform: 'none', color: 'var(--fg)' }}>CreditReportingConsentAudit Details</h3>
          ...
          <div style={{ display: 'grid', gap: '16px' }}>
            <div className="field">
              ...
              <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                {creditReportingConsentAudit.creditReportingEnrollmentID || 'N/A'}
              </div>
            </div>
            ...
            <div className="grid2">
              <div className="field">
                ...
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  {tenantIDMap[String(creditReportingConsentAudit.tenantID)] ?? creditReportingConsentAudit.tenantID ?? 'N/A'}
                </div>
              </div>
              ...
              <div className="field">
                ...
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  {creditReportingConsentAudit.action ?? 'N/A'}
                </div>
              </div>
              ...
              <div className="field">
                ...
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  {creditReportingConsentAudit.consentVersion ?? 'N/A'}
                </div>
              </div>
              ...
              <div className="field">
                ...
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  {creditReportingConsentAudit.consentTextHash ?? 'N/A'}
                </div>
              </div>
              ...
              <div className="field">
                ...
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  {creditReportingConsentAudit.providerReferenceID ?? 'N/A'}
                </div>
              </div>
              ...
              <div className="field">
                ...
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  {creditReportingConsentAudit.metadata ?? 'N/A'}
                </div>
              </div>
            ...
            <div className="field">
              <label className="field-label">Credit Reporting Consent Audit ID</label>
              <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default', fontFamily: 'monospace', color: 'var(--muted)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                {creditReportingConsentAudit.consentAuditID ?? 'N/A'}
              </div>
            </div>
