...
export default function FeeTypeViewModal({ feeType, isOpen, onClose }: FeeTypeViewModalProps) {
  React.useEffect(() => {
    ...
    >
      ...
      >
        <div className="card-header">
          <h3 className="card-title" style={{ fontSize: '1.25rem', textTransform: 'none', color: 'var(--fg)' }}>FeeType Details</h3>
        ...
        <div className="form">
          <div style={{ display: 'grid', gap: '16px' }}>
            ...
            <div className="grid2">
              <div className="field">
                <label className="field-label">Is Platform Fee</label>
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  <input type="checkbox" checked={feeType.isPlatformFee ?? false} readOnly style={{ cursor: 'default' }} />
                </div>
              </div>
            ...
            <div className="field">
              <label className="field-label">Fee Type ID</label>
