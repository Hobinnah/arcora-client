...
export default function CategoryViewModal({ category, isOpen, onClose }: CategoryViewModalProps) {
  React.useEffect(() => {
    ...
    >
      ...
      >
        <div className="card-header">
          <h3 className="card-title" style={{ fontSize: '1.25rem', textTransform: 'none', color: 'var(--fg)' }}>Category Details</h3>
            ...
            <div className="grid2">
              <div className="field">
                ...
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  <input type="checkbox" checked={category.maintenance ?? false} readOnly style={{ cursor: 'default' }} />
                </div>
              </div>
              ...
              <div className="field">
                ...
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  <input type="checkbox" checked={category.contractor ?? false} readOnly style={{ cursor: 'default' }} />
                </div>
              </div>
              ...
              <div className="field">
                ...
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  {category.capturedDate ? new Date(category.capturedDate as any).toLocaleDateString() : 'N/A'}
                </div>
              </div>
