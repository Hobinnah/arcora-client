...
interface AmenityCatalogViewModalProps {
  amenityCatalog: AmenityCatalog | null;
  isOpen: boolean;
  onClose: () => void;
}

export default function AmenityCatalogViewModal({ amenityCatalog, isOpen, onClose }: AmenityCatalogViewModalProps) {
  React.useEffect(() => {
  ...
  if (!isOpen || !amenityCatalog) return null;
    ...
    >
      ...
      >
        <div className="card-header">
          <h3 className="card-title" style={{ fontSize: '1.25rem', textTransform: 'none', color: 'var(--fg)' }}>AmenityCatalog Details</h3>
          ...
          <div style={{ display: 'grid', gap: '16px' }}>
            ...
            <div className="grid2">
              ...
              <div className="field">
                ...
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  <input type="checkbox" checked={amenityCatalog.isActive ?? false} readOnly style={{ cursor: 'default' }} />
                </div>
              </div>
            ...
            <div className="field">
              <label className="field-label">Amenity ID</label>
