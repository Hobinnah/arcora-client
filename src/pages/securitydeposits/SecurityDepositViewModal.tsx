...
interface SecurityDepositViewModalProps {
  securityDeposit: SecurityDeposit | null;
  isOpen: boolean;
  onClose: () => void;
}

export default function SecurityDepositViewModal({ securityDeposit, isOpen, onClose }: SecurityDepositViewModalProps) {
  ...
  const getStatusStyle = (status: string) => {
    switch (status) {
      case 'EXPECTED': return { backgroundColor: '#dcfce7', color: '#166534' };
      case 'PARTIALLY_FUNDED': return { backgroundColor: '#fef3c7', color: '#92400e' };
      case 'HELD': return { backgroundColor: '#e0ecff', color: '#1e3a8a' };
      case 'PARTIALLY_APPLIED': return { backgroundColor: '#f3e8ff', color: '#6b21a8' };
      case 'RETURN_PENDING': return { backgroundColor: '#ffe4e6', color: '#9f1239' };
      case 'RETURNED': return { backgroundColor: '#e5e7eb', color: '#374151' };
      case 'CLOSED': return { backgroundColor: '#dcfce7', color: '#166534' };
      default: return { backgroundColor: 'var(--surface)', color: 'var(--muted)' };
    }
  };

  if (!isOpen || !securityDeposit) return null;
    ...
    >
      ...
      >
        <div className="card-header">
          <h3 className="card-title" style={{ fontSize: '1.25rem', textTransform: 'none', color: 'var(--fg)' }}>SecurityDeposit Details</h3>
        ...
        <div className="form">
          <div style={{ display: 'grid', gap: '16px' }}>
            ...
            <div className="grid2">
              <div className="field">
                ...
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  <span style={{ display: 'inline-block', padding: '2px 8px', borderRadius: '12px', fontSize: '0.75rem', fontWeight: 500, ...getStatusStyle(securityDeposit.status || '') }}>
                    {securityDeposit.status || 'N/A'}
                  </span>
                </div>
              </div>
              ...
              <div className="field">
                ...
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  {leaseIDMap[String(securityDeposit.leaseID)] ?? securityDeposit.leaseID ?? 'N/A'}
                </div>
              </div>
              ...
              <div className="field">
                ...
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  {tenantIDMap[String(securityDeposit.tenantID)] ?? securityDeposit.tenantID ?? 'N/A'}
                </div>
              </div>
              ...
              <div className="field">
                ...
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  {organizationIDMap[String(securityDeposit.organizationID)] ?? securityDeposit.organizationID ?? 'N/A'}
                </div>
              </div>
              ...
              <div className="field">
                ...
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  {securityDeposit.requiredAmount ?? 'N/A'}
                </div>
              </div>
              ...
              <div className="field">
                ...
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  {securityDeposit.receivedAmount ?? 'N/A'}
                </div>
              </div>

              <div className="field">
                <label className="field-label">Applied Amount</label>
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  {securityDeposit.appliedAmount ?? 'N/A'}
                </div>
              </div>

              <div className="field">
                <label className="field-label">Returned Amount</label>
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  {securityDeposit.returnedAmount ?? 'N/A'}
                </div>
              </div>
              ...
              <div className="field">
                ...
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  {securityDeposit.dueDate ? new Date(securityDeposit.dueDate as any).toLocaleDateString() : 'N/A'}
                </div>
              </div>
            ...
            <div className="field">
              <label className="field-label">Security Deposit ID</label>
              <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default', fontFamily: 'monospace', color: 'var(--muted)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                {securityDeposit.securityDepositID ?? 'N/A'}
              </div>
            </div>
