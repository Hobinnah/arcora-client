...
interface UnitTypeViewModalProps {
  unitType: UnitType | null;
  isOpen: boolean;
  onClose: () => void;
}

export default function UnitTypeViewModal({ unitType, isOpen, onClose }: UnitTypeViewModalProps) {
  React.useEffect(() => {
    ...
    >
      ...
      >
        <div className="card-header">
          <h3 className="card-title" style={{ fontSize: '1.25rem', textTransform: 'none', color: 'var(--fg)' }}>UnitType Details</h3>
        ...
        <div className="form">
          <div style={{ display: 'grid', gap: '16px' }}>
            ...
            <div className="grid2">
              <div className="field">
                ...
                <div className="input" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', backgroundColor: 'var(--surface-2)', cursor: 'default' }}>
                  {unitType.capturedDate ? new Date(unitType.capturedDate as any).toLocaleDateString() : 'N/A'}
                </div>
              </div>
            ...
            <div className="field">
              <label className="field-label">Unit Type ID</label>
