  ...
  return (
    <><MarketplaceTrustSection /><footer className="marketplace-footer">
      <div className="marketplace-footer-columns">
        ...
        <div className="marketplace-footer-column"><h3>Hosting</h3><a href="#host">Arcora your home</a><a href="#resources">Hosting resources</a><a href="#responsibly">Hosting responsibly</a><a href="#cohost">Find a co-host</a><a href="/login?redirect_url=/become-a-host">Become a landlord</a></div>
